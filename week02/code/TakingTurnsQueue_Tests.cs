...
public class TakingTurnsQueueTests
{
    ...
    // even though 0 represents an infinite number of turns.
    ...
    // Defect(s) Found: A person with negative turns was not re-enqueued,
    // even though a negative value represents an infinite number of turns.
    ...
    // Defect(s) Found: None. The correct exception and message were returned.
